...
plot(growth$age,growth$Dt,xlab="Age (yr)",ylab="Test Diameter",
     xlim=c(0,25),ylim=c(1,10),type="l",main="Urchin Growth")
```
...
plot(ages,w.vec,main="Age vs. Weight",type='l',xlab='Age, years',ylab='Weight(g)',
     xaxs='i')
```
...
plot(ages,m.vec,main="Age vs. Maturity",xlab="Age",ylab="Proportion Mature",type="l")

```

#### Spawning stock biomass per recruit
Total unfished spawning stock biomass per recruit is just the summed product of weight-at-age and proportional numbers-at-age and maturity-at-age.
...
plot(0:max.age,q.vec,main="Age vs. Selectivity",type='l',xlab='Age, yr',
     ylab='Selectivity (proportion)',xaxs='i')
```
